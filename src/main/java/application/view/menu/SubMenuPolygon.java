...
public class SubMenuPolygon implements EditionSubMenu {
     ...
     */
    public SubMenuPolygon(ViewBridge view, int x, int y, int width, int height) {
        this.view = view;
    ...
    public void draw(int x, int y) {
        ...
        view.drawText("Number of side", x + 5, y + height/8, 30, Color.BLACK);
